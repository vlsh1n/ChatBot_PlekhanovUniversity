...
@dp.message_handler(text='Отдел по работе с участниками CV')
...
@dp.message_handler(text='Пресс центр CV')
async def category_curators(message: types.Message):
...
@dp.message_handler(text='Отдел планирования и снабжения CV')
async def category_curators(message: types.Message):
...
@dp.message_handler(text='Технический отдел CV')
async def category_curators(message: types.Message):
